#!/usr/bin/env python3
"""Builds a single-file, Notion-styled, RTL Arabic HTML edition of the book from book/chapters-ar/*.md."""
import re
import html
import markdown
...
CHAPTERS_DIR = ROOT / "chapters-ar"
OUT_HTML = Path(__file__).resolve().parent / "index.html"

# (filename stem, part label or None, emoji icon)
STRUCTURE = [
    ("00-preface", None, "👋"),
    ("01-why-start-a-startup", "الجزء الأول — ليه وإيه: الفكرة", "🚀"),
    ("02-anatomy-of-a-great-idea", "الجزء الأول — ليه وإيه: الفكرة", "💡"),
    ("03-monopoly-not-competition", "الجزء الأول — ليه وإيه: الفكرة", "👑"),
    ("04-choosing-a-cofounder", "الجزء الثاني — مين: الـ Founders والفريق", "🤝"),
    ("05-the-first-ten-hires", "الجزء الثاني — مين: الـ Founders والفريق", "🧑‍💼"),
    ("06-designing-company-culture", "الجزء الثاني — مين: الـ Founders والفريق", "🎨"),
    ("07-idea-to-mvp-talking-to-users", "الجزء الثالث — إيه: بناء المنتج", "🗣️"),
    ("08-building-products-users-love", "الجزء الثالث — إيه: بناء المنتج", "❤️"),
    ("09-doing-things-that-dont-scale", "الجزء الثالث — إيه: بناء المنتج", "🏃"),
    ("09b-interlude-hardware-in-a-software-world", "الجزء الثالث — إيه: بناء المنتج", "🔌"),
    ...
    ("13-how-to-raise-money", "الجزء الخامس — الفلوس", "💰"),
    ("14-pitching-and-fundraising-mechanics", "الجزء الخامس — الفلوس", "🎤"),
    ("15-legal-and-financial-mechanics", "الجزء الخامس — الفلوس", "⚖️"),
    ("16-selling-first-customer-to-enterprise-deal", "الجزء الخامس — الفلوس", "🛒"),
...
# heading text (substring match) -> (emoji, css class) — matches the fixed Arabic
# translations used consistently across every chapter during translation.
SECTION_STYLES = [
    ("الفكرة الأساسية", "💡", "callout-blue"),
    ("ليه ده صحيح", "🔍", "callout-teal"),
    ("أخطاء شائعة", "⚠️", "callout-red"),
    ("مقايضات وحالات خاصة", "⚖️", "callout-purple"),
    ("تطبيق عملي", "🧪", "callout-green"),
    ("خلاصة الفصل", "✅", "callout-yellow"),
    ("تمارين", "📝", "callout-pink"),
    ("لو حابب تقرأ أكتر", "📚", "callout-gray"),
]
...
<head>
<meta charset="UTF-8">
<title>إزاي تبدأ Startup — الكتاب</title>
...
<body>
<nav class="sidebar">
  <div class="sidebar-title">📘 إزاي تبدأ Startup</div>
  {{SIDEBAR}}
</nav>
<main>
{{CONTENT}}
